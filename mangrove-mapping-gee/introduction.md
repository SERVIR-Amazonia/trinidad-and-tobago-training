...
3. Create a new script file - name it whatever you want. This will be your copy of the 'Mangroves Classification - Landsat' script in the training script repository above.
